DROP FUNCTION IF EXISTS run_lifecycle_retention_stats(INT, INT, INT, INT, INT, INT, INT);

ALTER TABLE lifecycle_maintenance_runs
  DROP COLUMN IF EXISTS quiz_attempts_pruned,
  DROP COLUMN IF EXISTS learning_sessions_pruned,
  DROP COLUMN IF EXISTS flashcard_reviews_pruned,
  DROP COLUMN IF EXISTS share_links_pruned,
  DROP COLUMN IF EXISTS user_profiles_pruned,
  DROP COLUMN IF EXISTS learning_review_days,
  DROP COLUMN IF EXISTS share_days,
  DROP COLUMN IF EXISTS profile_days;
